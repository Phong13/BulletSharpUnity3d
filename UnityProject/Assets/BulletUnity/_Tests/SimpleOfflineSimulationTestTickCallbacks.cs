...
*/
public class SimpleOfflineSimulationTestTickCallbacks : MonoBehaviour {

    void PreInternalTickCallback(DynamicsWorld world, float timeStep)
    {
        Debug.Log("Pre internal tick callback");
    }

    void PostInternalTickCallback(DynamicsWorld world, float timeStep)
    {
        Debug.Log("Post internal tick callback");
    }
    ...
    void Start () {
        ...
        World.SetInternalTickCallback(PreInternalTickCallback, null, true);
        World.SetInternalTickCallback(PostInternalTickCallback, null, false);
