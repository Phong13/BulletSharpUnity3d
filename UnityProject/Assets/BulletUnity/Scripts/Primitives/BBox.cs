...
namespace BulletUnity.Primitives
{
    ...
    public class BBox : BPrimitive
    {
        ...
        {
            GetComponent<MeshFilter>().sharedMesh = ProceduralPrimitives.CreateMeshBox(meshSettings.extents.x, meshSettings.extents.y, meshSettings.extents.z, meshSettings.autoWeldVertices );
