...
namespace BulletSharp
{
	public class SphereSphereCollisionAlgorithm : ActivatingCollisionAlgorithm
	{
		public class CreateFunc : CollisionAlgorithmCreateFunc
		{
			...
			public CreateFunc()
				: base(UnsafeNativeMethods.btSphereSphereCollisionAlgorithm_CreateFunc_new(), false)
			{
			}

			public override CollisionAlgorithm CreateCollisionAlgorithm(CollisionAlgorithmConstructionInfo __unnamed0, CollisionObjectWrapper body0Wrap, CollisionObjectWrapper body1Wrap)
			{
				return new SphereSphereCollisionAlgorithm(UnsafeNativeMethods.btCollisionAlgorithmCreateFunc_CreateCollisionAlgorithm(
		...
		public SphereSphereCollisionAlgorithm(PersistentManifold mf, CollisionAlgorithmConstructionInfo ci,
			...
			: base(UnsafeNativeMethods.btSphereSphereCollisionAlgorithm_new(mf.Native, ci.Native, col0Wrap.Native,
				col1Wrap.Native))
		{
		}

		public SphereSphereCollisionAlgorithm(CollisionAlgorithmConstructionInfo ci)
			: base(UnsafeNativeMethods.btSphereSphereCollisionAlgorithm_new2(ci.Native))
		{
		}
	}
}
