...
namespace BulletSharp.SoftBody
{
	...
	public class AlignedClusterArrayEnumerator : IEnumerator<Cluster>
	{
		...
		public Cluster Current{ get { return  _array[_i];} }
	...
	public class AlignedClusterArray : IList<Cluster>
	{
		...
		public Cluster this[int index]
		{
			get
			{
				...
				return new Cluster(UnsafeNativeMethods.btAlignedObjectArray_btSoftBody_ClusterPtr_at(_native, index));
			}
			set
			{
				throw new NotImplementedException();
		...
		{
			UnsafeNativeMethods.btAlignedObjectArray_btSoftBody_ClusterPtr_push_back(_native, item.Native);
		}

		public void Clear()
		{
			UnsafeNativeMethods.btAlignedObjectArray_btSoftBody_ClusterPtr_resizeNoInitialize(_native, 0);
		}
		...
		public int Count{ get { return  UnsafeNativeMethods.btAlignedObjectArray_btSoftBody_ClusterPtr_size(_native);} }
