...
namespace BulletSharp.SoftBody
{
	...
	public class AlignedAnchorArrayEnumerator : IEnumerator<Anchor>
	{
		...
		public Anchor Current{ get { return  _array[_i];} }
	...
	public class AlignedAnchorArray : IList<Anchor>
	{
		...
		public Anchor this[int index]
		{
			get
			{
				...
				return new Anchor(UnsafeNativeMethods.btAlignedObjectArray_btSoftBody_Anchor_at(_native, index));
			}
			set
			{
				throw new NotImplementedException();
		...
		{
			UnsafeNativeMethods.btAlignedObjectArray_btSoftBody_Anchor_push_back(_native, item.Native);
		}

		public void Clear()
		{
			UnsafeNativeMethods.btAlignedObjectArray_btSoftBody_Anchor_resizeNoInitialize(_native, 0);
		}
		...
		public int Count{ get { return  UnsafeNativeMethods.btAlignedObjectArray_btSoftBody_Anchor_size(_native);} }
