...
namespace BulletSharp.SoftBody
{
	...
	public class AlignedTetraArrayEnumerator : IEnumerator<Tetra>
	{
		...
		public Tetra Current{ get { return  _array[_i];} }
	...
	public class AlignedTetraArray : IList<Tetra>
	{
		...
		public Tetra this[int index]
		{
			get
			{
				...
				return new Tetra(UnsafeNativeMethods.btAlignedObjectArray_btSoftBody_Tetra_at(_native, index));
			}
			set
			{
				throw new NotImplementedException();
		...
		{
			UnsafeNativeMethods.btAlignedObjectArray_btSoftBody_Tetra_push_back(_native, item.Native);
		}

		public void Clear()
		{
			UnsafeNativeMethods.btAlignedObjectArray_btSoftBody_Tetra_resizeNoInitialize(_native, 0);
		}
		...
		public int Count{ get { return  UnsafeNativeMethods.btAlignedObjectArray_btSoftBody_Tetra_size(_native);} }
