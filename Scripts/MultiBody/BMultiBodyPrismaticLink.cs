using BulletUnity;
using UnityEngine;
public class BMultiBodyPrismaticLink : BMultiBodyLink
{
    ...
    public override void SetupLink(BulletSharp.Math.Vector3 linkInertia)
    {
        ...
        MultiBody.MultiBody.SetupPrismatic(LinkId, Mass, linkInertia, ParentLinkId, parentToThisRotation.ToBullet(), JointAxis.ToBullet(),
